...
"[project]/frontend/lib/genlayer/client.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/genlayer-js/dist/index.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$chains$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/genlayer-js/dist/chains/index.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$chunk$2d$GEN4SJ6K$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/genlayer-js/dist/chunk-GEN4SJ6K.js [app-ssr] (ecmascript)");
...
function createMetaMaskWalletClient() {
    ...
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$clients$2f$createWalletClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createWalletClient"])({
            chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$chunk$2d$GEN4SJ6K$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studionet"],
            transport: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$viem$2f$_esm$2f$clients$2f$transports$2f$custom$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["custom"])(provider)
        });
    } catch (error) {
...
function createGenLayerClient(address) {
    ...
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(config);
    } catch (error) {
        console.error("Error creating GenLayer client:", error);
        // Return client without account on error
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])({
            chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genlayer$2d$js$2f$dist$2f$chunk$2d$GEN4SJ6K$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["studionet"]
        });
    }
}
...
"[project]/frontend/lib/utils/toast.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
const promise = (promise, messages, options)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].promise(promise, {
...
const __TURBOPACK__default__export__ = {
    ...
    configError,
    userRejected,
    toast: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"]
};
}),
"[project]/frontend/lib/genlayer/WalletProvider.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/genlayer/client.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/frontend/lib/utils/toast.ts [app-ssr] (ecmascript) <locals>");
"use client";
;
;
;
...
function WalletProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initWallet = async ()=>{
            const installed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMetaMaskInstalled"])();
            if (!installed) {
                setState({
                    address: null,
                    chainId: null,
            ...
            try {
                ...
                const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccounts"])();
                const chainId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentChainId"])();
                const correctNetwork = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isOnGenLayerNetwork"])();
                setState({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getEthereumProvider"])();
        if (!provider) {
            return;
        }
        ...
        const handleChainChanged = async (chainId)=>{
            ...
            const correctNetwork = parseInt(chainId, 16) === __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GENLAYER_CHAIN_ID"];
            const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAccounts"])();
            setState((prev)=>({
                    ...prev,
                    chainId,
   ...
   */ const connectWallet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            const address = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["connectMetaMask"])();
            const chainId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentChainId"])();
            const correctNetwork = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isOnGenLayerNetwork"])();
            ...
            if (err.message?.includes("rejected")) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["userRejected"])("Connection cancelled");
            } else if (err.message?.includes("MetaMask is not installed")) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["error"])("MetaMask not found", {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["error"])("Failed to connect wallet", {
   ...
   */ const switchWalletAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            setState((prev)=>({
                    ...prev,
                    isLoading: true
            ...
            const newAddress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["switchAccount"])();
            // Get updated state
            const chainId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCurrentChainId"])();
            const correctNetwork = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isOnGenLayerNetwork"])();
            ...
            if (err.message?.includes("rejected")) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["userRejected"])("Account switch cancelled");
            } else {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$utils$2f$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["error"])("Failed to switch account", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sonner/dist/index.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$WalletProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/lib/genlayer/WalletProvider.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function Providers({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
        client: queryClient,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$genlayer$2f$WalletProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WalletProvider"], {
                children: children
            }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cc3b645c._.js.map